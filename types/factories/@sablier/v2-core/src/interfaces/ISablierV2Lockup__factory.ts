...
import type {
  ISablierV2Lockup,
  ISablierV2LockupInterface,
} from "../../../../../@sablier/v2-core/src/interfaces/ISablierV2Lockup";
...
export class ISablierV2Lockup__factory {
  static readonly abi = _abi;
  static createInterface(): ISablierV2LockupInterface {
    return new Interface(_abi) as ISablierV2LockupInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISablierV2Lockup {
    return new Contract(address, _abi, runner) as unknown as ISablierV2Lockup;
  }
}
