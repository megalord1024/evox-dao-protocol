...
export interface IAdminableInterface extends Interface {
  getFunction(nameOrSignature: "admin" | "transferAdmin"): FunctionFragment;
...
export interface IAdminable extends BaseContract {
  connect(runner?: ContractRunner | null): IAdminable;
  waitForDeployment(): Promise<this>;

  interface: IAdminableInterface;
